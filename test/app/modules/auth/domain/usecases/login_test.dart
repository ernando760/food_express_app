...
void main() {
  late final MockLogin usecase;

  setUpAll(() {
    usecase = MockLogin();
    registerFallbackValue(FakeUserDto());
  });
  test('It should return the user and the token when making the login.',
      () async {
  ...
  test('It should return the exception when making the login.', () async {
